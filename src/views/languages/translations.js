export default {
    en: {
        ...
        messages: {
            ...
            withdraw : 'WITHDRAW',
            personalInfo : 'Personal locked up plan (Monthly statistical summary）',
            communityInfo : 'Community locked up plan (Monthly statistical summary）',
...
Again: we are not a bank`,
            needUnderstand : `We need you to understand that we cannot...`,
            desNeedUnderstand : `Access your account or send your funds for you.
...
Install an AdBlocker and do not click ads on your search engine (e.g. Google).`,
            ...
            desProtectLoss : `If you lose your private key or password, it is gone forever. Don't lose it.
...
More Security Tips!`,
            ...
            transferToAddress: 'Transfer BCST to',
            ...
            bcstLock: 'Bcst lock warehouse plan description',
            desBCSTLock1: '1. When you create an account on bcst.Bcschain.io, you will get a set of encrypted numbers: your private key and public key (address). (web version of light wallet) The processing of your key is performed entirely on your computer.' ,
            desBCSTLock1_1: 'We never transmit, receive or store your private key, password or other account information. ',
            desBCSTLock1_2: 'We do not charge a transaction fee. ',
            desBCSTLock1_3: 'You just use our webpage to make transaction directly with the blockchain. ',
            desBCSTLock1_4: "If you send a public key (address) to someone, they can send you ETH or other token.",
            desBCSTLock1_5: 'If you send your private key to someone, they now have full control over your account. ',
            desBCSTLock2: '2. Because you are using the blockchain to do the time deposit. To ensure that your smart contract is open, please deposit at least 0.02ETH into your address as gas fee.' ,
            ...
            waringShowPK1: 'Note',
            waringShowPK2_1: `It is recommended that you store backups of both forms of your key (the Keystore / UTC file version and paper wallet version) in physically separate, offline environments.` ,
            waringShowPK2_2: `This prevents loss of the private key & password due to: dead hard drive, lost USB drive, wet piece of paper, etc. Keep in mind that physical loss can affect an entire area (e.g. fire, flood).`,
            waringShowPK3: `We cannot recover your key `,
            waringShowPK4_1: `We are not a web wallet and cannot recover your private key or password, access your account, move funds, recover funds, nor cancel/reverse transactions. `,
            waringShowPK4_2:`We are a client-side interface that allows you to interact with the Ethereum blockchain. Please secure & back up your key like the millions of dollars it could some day be worth.`,
            personal: 'personal',
            community: 'community',
            addOnCommu: 'Enter add-on community investment',
            deposit: 'Deposit',
            sumPrinciple: 'Sum of principle',
            sumProfit: 'Sum of profit',
            maxAnnualized: 'Max annualized',
            profit: 'profit',
            timeLeft: 'Time left',
            backupPK: 'BACKUP WALLET AS PRIVATE KEY',
            backupKeystore: 'BACKUP WALLET AS KEYSTORE',
            viewOnExchage: 'BCST Trade Views On Exchage',
            show: 'show',
            hide: 'hide',
...
人们会试图让你给他们钱，以换取一切。`,
            ...
            desProtectLoss : `如果您丢失了私钥或密码，它将永远消失。不要失去它。
...
如果您有超过1周的加密货币价值，请购买硬件钱包。没有理由。这很值得。我承诺。`,
            ...
            bcstLock : 'Bcst锁仓计划说明',
            desBCSTLock1 : '1. 您在bcst.Bcschain.io上创建帐户时，您将生成一组加密数字：您的私钥和公钥（地址）。（网页版轻钱包形式）您的密钥的处理完全在您的计算机上执行。',
            desBCSTLock1_1 : '我们从不传输，接收或存储您的私钥，密码或其他帐户信息。',
            desBCSTLock1_2 : '我们不收取交易费。',
            desBCSTLock1_3 : '您只是使用我们的界面直接与区块链进行交互。',
            desBCSTLock1_4 : '如果您将公钥（地址）发送给某人，他们可以向您发送ETH或令牌。',
            desBCSTLock1_5 : '如果您将私钥发送给某人，他们现在可以完全控制您的帐户。 ',
            desBCSTLock2 : '2. 因为您是直接使用区块链进行锁仓 为了确保您的合约打开，请第一时间往您的地址中存入0.02ETH 作为燃料。（燃料激活为ERC20智能合约锁仓基本要求）',
            ...
            waringShowPK1: '注意',
            waringShowPK2_1: `建议您将两种形式的密钥（Keystore / UTC文件版本和纸质钱包版本）的备份存储在物理上独立的脱机环境中。`,
            waringShowPK2_2: `这样可以防止因以下原因丢失私钥和密码：死硬盘，丢失的USB驱动器，湿纸等。请记住，物理损失会影响整个区域（例如火灾，洪水）。 `,
            waringShowPK3: `我们无法恢复您的密钥 `,
            waringShowPK4_1: `我们不是网络钱包，无法恢复您的私钥或密码，访问您的帐户，转移资金，追回资金，也无法取消/撤销交易。`, 
            waringShowPK4_2: `我们是一个客户端界面，允许您与以太坊区块链进行交互。请保护并备份您的密钥，就像有朝一日值得的数百万美元。 `,        
            personal: '个人',
            community: '社区',
            addOnCommu: '输入社区锁仓数额',
            deposit: '存款',
            ...
            timeLeft: '剩余时间',
            backupPK: '备份钱包私钥',
            backupKeystore: '备份钱包keystore文件',
            viewOnExchage: 'BCST交易所交易情况概览',
            show: '显示',
            hide: '隐藏',
