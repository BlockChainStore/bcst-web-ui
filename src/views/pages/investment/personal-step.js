...
class InvestmentStep extends React.Component {
    ...
    handleNext = () => {
        switch (this.state.activeStep) {
            case 1:
                ...
                const inputMax = balance < 300000 ? balance : 300000
                const validator = Joi.number().min(10001).max(inputMax)
    ...
    handleConfirm = () => {
        ...
        investmentActions.onSubmitPersonalInvestment(this.state.bcst, this.state.day)
